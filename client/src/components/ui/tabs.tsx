...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      "inline-flex h-10 max-w-full items-center justify-start overflow-x-auto overflow-y-hidden rounded-md bg-muted p-1 text-muted-foreground [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
      className
    )}
    {...props}
  />
